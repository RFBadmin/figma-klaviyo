    ...
    y2(() => {
      ...
      setFrameStates((prev) => {
        ...
        frames.forEach((f4) => {
          ...
          if ((existing == null ? void 0 : existing.figmaSliceImages) !== null && (existing == null ? void 0 : existing.figmaSliceImages) !== void 0 && !f4.hasFigmaSlices) {
  ...
  function FrameWorkflow({ frame, state, fromFigmaSlices, onSlice, onReSlice, onSlicesChange, onApplyAndCompress, onRecompress, onStepChange, onErrorDismiss, onCancelSlice }) {
    ...
    return /* @__PURE__ */ u3("div", { children: [
      ...
      step === "preview" && /* @__PURE__ */ u3("div", { class: "step-panel", children: [
        ...
        /* @__PURE__ */ u3("div", { class: "action-row", children: /* @__PURE__ */ u3("button", { class: "btn-primary", style: { flex: 1 }, onClick: onApplyAndCompress, children: "Apply & Compress \u2192" }) })
      ] }),
