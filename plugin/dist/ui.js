...
(() => {
  ...
  function DesignerMode({ frames, onSwitchToTech }) {
    ...
    y2(() => {
      ...
      setFrameStates((prev) => {
        const next = __spreadValues({}, prev);
        frames.forEach((f4) => {
          if (f4.existingSliceData && !next[f4.id]) {
    ...
    const applyAndCompressAll = q2(() => __async(null, null, function* () {
      ...
      const targets = frames.filter((f4) => {
        var _a3, _b2;
        const s3 = (_b2 = (_a3 = frameStates[f4.id]) == null ? void 0 : _a3.step) != null ? _b2 : "select";
        return s3 === "preview" || s3 === "applied";
      });
      if (targets.length === 0) return;
      ...
      for (let i3 = 0; i3 < targets.length; i3++) {
        ...
        if (step === "preview") {
          if (targetState.figmaSliceImages !== null) {
            ...
            const imgMap = yield applyToFrame(targets[i3], targetState);
            if (!imgMap) continue;
            stateForCompress = __spreadProps(__spreadValues({}, targetState), { figmaSliceImages: imgMap, step: "applied" });
          }
        }
        yield compressAndSave(targets[i3], stateForCompress);
      }
  ...
  function FrameWorkflow({ frame, state, fromFigmaSlices, onSlice, onReSlice, onSlicesChange, onApplyToFrame, onCompress, onSave, onStepChange, onErrorDismiss, onCancelSlice, compressQuality, compressMaxKb, compressFormat, onQualityChange, onMaxKbChange, onFormatChange }) {
    ...
    return /* @__PURE__ */ u3("div", { children: [
      ...
      step === "preview" && /* @__PURE__ */ u3("div", { class: "step-panel", children: [
        ...
        /* @__PURE__ */ u3("div", { class: "action-row", children: fromFigmaSlices ? /* @__PURE__ */ u3("button", { class: "btn-primary", style: { flex: 1 }, onClick: () => onStepChange("applied"), children: "Use These Slices \u2192" }) : /* @__PURE__ */ u3("button", { class: "btn-primary", style: { flex: 1 }, onClick: onApplyToFrame, children: "Apply to Frame \u2192" }) })
      ] }),
      step === "applied" && /* @__PURE__ */ u3("div", { class: "step-panel", children: [
        /* @__PURE__ */ u3("p", { class: "success-inline", children: "\u2713 Slice nodes ready on frame in Figma" }),
      ...
      step === "results" && compressResponse && /* @__PURE__ */ u3("div", { class: "step-panel", children: [
        ...
        /* @__PURE__ */ u3("div", { class: "action-row", children: [
          /* @__PURE__ */ u3("button", { class: "btn-secondary", onClick: () => onStepChange("preview"), children: "\u2190 Adjust Slices" }),
          /* @__PURE__ */ u3("button", { class: "btn-secondary", onClick: onCompress, children: "\u21BB Re-compress" }),
          /* @__PURE__ */ u3(
            "button",
            {
              class: "btn-primary",
