...
(() => {
  ...
  function DesignerMode({ frames, onSwitchToTech }) {
    ...
    const patchState = q2((frameId, patch) => {
      setFrameStates((prev) => {
        ...
        return __spreadProps(__spreadValues({}, prev), {
          [frameId]: __spreadValues(__spreadValues({}, (_a2 = prev[frameId]) != null ? _a2 : defaultState()), patch)
        });
      });
    }, []);
    y2(() => {
      ...
      setFrameStates((prev) => {
        ...
        frames.forEach((f4) => {
          ...
          if (existing && existing.step !== "select" && existing.step !== "analyzing" && !f4.hasFigmaSlices && !f4.existingSliceData && existing.figmaSliceImages !== null) {
    ...
    y2(() => {
      ...
      if (state.figmaSliceImages !== null) return;
    ...
    }, [frame == null ? void 0 : frame.id, state.step, state.imageBase64, state.figmaSliceImages]);
    y2(() => {
    ...
    const sliceFrame = q2((targetFrame, forceAI = false) => __async(null, null, function* () {
      ...
      if (!forceAI) {
        let figmaSlices = [];
        try {
          figmaSlices = yield requestFigmaSlices(targetFrame.id);
        } catch (e3) {
        }
        if (figmaSlices.length > 0) {
          ...
          figmaSlices.forEach((s3, i3) => imgMap.set(newSlices[i3].id, s3.imageBase64));
    ...
    const applyToFrame = q2((targetFrame, currentState) => __async(null, null, function* () {
      try {
        ...
        const imgMap = /* @__PURE__ */ new Map();
        currentState.slices.forEach((s3, i3) => {
          var _a2;
          if ((_a2 = exported[i3]) == null ? void 0 : _a2.imageBase64) imgMap.set(s3.id, exported[i3].imageBase64);
        });
    ...
    const compressAndSave = q2((targetFrame, currentState) => __async(null, null, function* () {
      ...
      try {
        let sliceExports;
        if ((_a2 = currentState.figmaSliceImages) == null ? void 0 : _a2.size) {
          const allHaveImages = currentState.slices.every((s3) => currentState.figmaSliceImages.has(s3.id));
          if (allHaveImages) {
            sliceExports = currentState.slices.map((s3) => ({
              id: s3.id,
              name: s3.name,
              image_base64: currentState.figmaSliceImages.get(s3.id)
            }));
          } else {
    ...
    const applyCompressSaveAll = q2(() => __async(null, null, function* () {
      ...
      const targets = previewTargets.map((f4) => {
        var _a2;
        return {
          frame: f4,
          state: __spreadValues({}, (_a2 = frameStatesRef.current[f4.id]) != null ? _a2 : defaultState())
        };
      });
      setApplyBatchProgress({ current: 0, total: targets.length });
      for (let i3 = 0; i3 < targets.length; i3++) {
        setApplyBatchProgress({ current: i3, total: targets.length });
        const { frame: targetFrame, state: targetState } = targets[i3];
    ...
    return /* @__PURE__ */ u3("div", { class: "designer-mode", children: [
          ...
          return /* @__PURE__ */ u3(
            "div",
            {
              ...
              children: [
                ...
                f4.hasFigmaSlices && fs.step === "select" && /* @__PURE__ */ u3("span", { class: "frame-check-badge figma-badge", title: "Has Figma Slice nodes", children: "\u2702" })
              ]
            },
            f4.id
          );
      ...
      frames.some((f4) => {
        ...
        /* @__PURE__ */ u3("div", { style: { fontSize: 11, color: "#888", marginBottom: 6, fontStyle: "italic" }, children: "\u2699 Compression settings apply to all frames" }),
        /* @__PURE__ */ u3("div", { class: "format-row", children: [
          /* @__PURE__ */ u3("span", { class: "settings-label", children: "Output Format" }),
          /* @__PURE__ */ u3("div", { class: "format-options", children: ["auto", "jpeg", "png"].map((fmt) => /* @__PURE__ */ u3(
            "button",
            {
          ...
          compressFormat === "png" && /* @__PURE__ */ u3("span", { class: "format-note", children: "PNG is lossless \u2014 quality slider ignored" })
        ] }),
        compressFormat !== "png" && /* @__PURE__ */ u3("div", { class: "slider-row", children: [
          ...
          /* @__PURE__ */ u3(
            "input",
            {
              ...
              onInput: (e3) => setCompressQuality(+e3.target.value)
            }
          ),
        ...
        /* @__PURE__ */ u3("div", { class: "slider-row", children: [
          ...
          /* @__PURE__ */ u3(
            "input",
            {
              ...
              step: 25,
              value: compressMaxKb,
              onInput: (e3) => setCompressMaxKb(+e3.target.value)
            }
          ),
          /* @__PURE__ */ u3("div", { class: "slider-hints", children: [
            /* @__PURE__ */ u3("span", { children: "50 KB" }),
            /* @__PURE__ */ u3("span", { children: "400 KB" })
          ] })
        ] })
      ] }),
  ...
  function FrameWorkflow({ frame, state, fromFigmaSlices, onSlice, onReSlice, onSlicesChange, onRecompress, onStepChange, onErrorDismiss, onCancelSlice }) {
    ...
    return /* @__PURE__ */ u3("div", { children: [
      error && /* @__PURE__ */ u3("div", { class: "error-banner", children: [
        "\u26A0 ",
        error,
        /* @__PURE__ */ u3("button", { onClick: onErrorDismiss, children: "\u2715" })
      ] }),
      ...
      step === "preview" && /* @__PURE__ */ u3("div", { class: "step-panel", children: [
        fromFigmaSlices && /* @__PURE__ */ u3("p", { class: "figma-slices-notice", children: [
          "\u2702 Using ",
          slices.length,
          " Figma slice node",
          slices.length !== 1 ? "s" : "",
      ...
      step === "results" && compressResponse && /* @__PURE__ */ u3("div", { class: "step-panel", children: [
        ...
        /* @__PURE__ */ u3("div", { class: "action-row", children: [
          ...
          /* @__PURE__ */ u3("button", { class: "btn-secondary", onClick: onRecompress, children: "\u21BB Re-compress" })
        ] })
      ] }),
      step === "saved" && /* @__PURE__ */ u3("div", { class: "step-panel success", children: [
        ...
        /* @__PURE__ */ u3("button", { class: "btn-secondary", onClick: () => onStepChange("preview"), children: "Edit Slices" })
      ] })
    ] });
  }
  function CompressionResults({ response }) {
    ...
    return /* @__PURE__ */ u3("div", { class: "compression-results", children: [
      /* @__PURE__ */ u3("div", { class: "targets-box", children: [
        /* @__PURE__ */ u3("span", { children: "Per image: \u2264400KB limit \u2502 originals used if under limit" }),
  ...
  function KlaviyoConfig({ apiKey, backendUrl, defaultTemplateName = "", onChange }) {
    const [lists, setLists] = d2([]);
    const [loading, setLoading] = d2(false);
    const [listError, setListError] = d2(null);
    ...
    return /* @__PURE__ */ u3("div", { class: "klaviyo-config", children: [
      ...
      config.mode === "campaign" && /* @__PURE__ */ u3(k, { children: [
        ...
        /* @__PURE__ */ u3("div", { class: "form-field", children: [
          ...
          loading ? /* @__PURE__ */ u3("p", { style: { fontSize: 12, color: "#666" }, children: "Loading lists\u2026" }) : listError ? /* @__PURE__ */ u3("p", { style: { fontSize: 12, color: "#e74c3c" }, children: [
            "\u26A0 ",
            listError
          ] }) : /* @__PURE__ */ u3(
            "select",
  ...
  function TechMode({ frames }) {
    ...
    const [error, setError] = d2(null);
    const [pushResults, setPushResults] = d2([]);
      ...
      const handler = (event) => {
        ...
        if (msg.type === "LAST_BRAND_LOADED" && msg.brand) {
          fetch(`${BACKEND_URL}/api/brands/${encodeURIComponent(msg.brand)}/key`, {
            headers: authHeaders()
          }).then((r3) => r3.ok ? r3.json() : Promise.reject()).then((data) => {
    ...
    const handlePreviewHtml = q2(() => __async(null, null, function* () {
      ...
      try {
        const enrichedSlices = editedSlices.map((s3) => __spreadValues({}, s3));
        for (const f4 of readyFrames) {
          const imageMap = yield fetchFigmaSliceImages(f4.id);
          for (const slice of enrichedSlices) {
            if (slice._frameId === f4.id) {
              const img = imageMap.get(slice.name);
              if (img) slice.image_base64 = img;
            }
          }
        }
    ...
    const handlePush = q2(() => __async(null, null, function* () {
      ...
      try {
        for (const f4 of readyFrames) {
          setPushingFrame(f4.name);
          const imageMap = yield fetchFigmaSliceImages(f4.id);
          const frameSlices = editedSlices.filter((s3) => s3._frameId === f4.id);
          const slicesForPush = frameSlices.map((s3) => {
            const freshImage = imageMap.get(s3.name);
            return freshImage ? __spreadProps(__spreadValues({}, s3), { image_base64: freshImage }) : s3;
          });
          const isMultiFrame = readyFrames.length > 1;
          const frameConfig = __spreadProps(__spreadValues({}, klaviyoConfig), {
...
${JSON.stringify(errData.detail, null, 2)}` : "";
            throw new Error(`[${f4.name}] ${errData.error || `Push failed: ${res.statusText}`}${detail}`);
          }
          const data = yield res.json();
          results.push({
            frameName: f4.name,
    ...
    return /* @__PURE__ */ u3("div", { class: "tech-mode", children: [
      ...
      step === "configure" && /* @__PURE__ */ u3("div", { class: "step-panel", children: [
        ...
        readyFrames.length === 0 ? /* @__PURE__ */ u3("div", { class: "warning-box", children: "\u26A0 No sliced frames found. Have the Design team slice frames first." }) : /* @__PURE__ */ u3(k, { children: [
          /* @__PURE__ */ u3("div", { class: "design-summary", children: [
            ...
            /* @__PURE__ */ u3("div", { children: [
              /* @__PURE__ */ u3("strong", { children: readyFrames.length === 1 ? readyFrames[0].name : `${readyFrames.length} frames \u2192 ${readyFrames.length} templates` }),
              /* @__PURE__ */ u3("span", { children: [
                editedSlices.length,
                " slices total"
              ] })
          ...
          readyFrames.length > 1 && /* @__PURE__ */ u3("p", { class: "multi-frame-note", children: [
            "\u2139 ",
            readyFrames.length,
            " frames selected \u2014 each will create a separate template",
            (klaviyoConfig == null ? void 0 : klaviyoConfig.mode) === "campaign" ? " and campaign" : "",
            "."
          ] }),
          /* @__PURE__ */ u3(
            KlaviyoConfig,
          ...
          /* @__PURE__ */ u3("div", { class: "action-row", children: [
            ...
            /* @__PURE__ */ u3(
              "button",
              {
                ...
                onClick: handlePush,
                children: readyFrames.length > 1 ? `Push ${readyFrames.length} Frames \u2192` : "Push to Klaviyo \u2192"
              }
            )
          ] }),
      ...
      step === "pushing" && /* @__PURE__ */ u3("div", { class: "step-panel loading", children: [
        /* @__PURE__ */ u3("div", { class: "spinner" }),
        /* @__PURE__ */ u3("p", { children: [
          "Uploading to Klaviyo\u2026",
          pushingFrame ? ` (${pushingFrame})` : ""
        ] }),
        pushResults.length > 0 && /* @__PURE__ */ u3("p", { class: "push-progress", children: [
          pushResults.length,
          " of ",
          readyFrames.length,
          " done"
      ...
      step === "done" && pushResults.length > 0 && /* @__PURE__ */ u3("div", { class: "step-panel success", children: [
        /* @__PURE__ */ u3("p", { children: [
          "\u2713 Successfully pushed ",
          pushResults.length,
          " frame",
          pushResults.length !== 1 ? "s" : "",
          " to Klaviyo!"
        ] }),
        /* @__PURE__ */ u3("div", { class: "push-results-list", children: pushResults.map((r3, i3) => /* @__PURE__ */ u3("div", { class: "push-result-item", children: [
          pushResults.length > 1 && /* @__PURE__ */ u3("strong", { class: "result-frame-name", children: [
            "\u{1F4C4} ",
            r3.frameName
          ] }),
    ...
    return new Promise((resolve) => {
      ...
      const handler = (event) => {
        ...
        if (msg.type === "FIGMA_SLICES_LOADED") {
          for (const s3 of msg.slices) {
            map.set(s3.name, s3.imageBase64);
          }
        }
        resolve(map);
      };
